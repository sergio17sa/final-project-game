...
public class NetworkUIController : NetworkBehaviour
{
    ...
    //         player1Account.OnValueChanged += (NetString oldVal, NetString newValue) =>
    //         {
    //             UIManager.Instance.player1Name.text =  newValue.id.ToString();
    //         };
    ...
    //     [ServerRpc]
    //     private void OnSwitchChangeServerRpc( NetString id ){
